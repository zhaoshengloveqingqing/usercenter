 ...
 * @since 2014-08-04
 */
class OAuth2_Provider_Yixin extends Oauth2_Provider {
    ...
    {
        return OAUTH_YIXIN_AUTHORIZE_URL;
    }

    public function url_access_token()
    {
        return OAUTH_YIXIN_ACCESS_TOKEN_URL;
    }

    public function get_user_info(OAuth2_Token_Access $token)
    {
        $url = OAUTH_YIXIN_USER_INFO_URL.'?'.http_build_query(array(
	...
	*/
    public function authorize($options = array())
    {
        ...
        return $this->url_authorize().'?'.http_build_query($params).'#yixin_redirect';
    }
