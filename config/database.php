...
if(getenv('PINET_WEB_ENV')) {
	$active_group =getenv('PINET_WEB_ENV');
}
else {
...
$db['default']['password'] = '';
$db['default']['database'] = 'pinet_usercenter';
$db['default']['dbdriver'] = 'mysql';
$db['default']['dbprefix'] = 'pinet_';
...
$db['testing']['password'] = '';
$db['testing']['database'] = 'pinet_usercenter_test';
$db['testing']['dbdriver'] = 'mysql';
$db['testing']['dbprefix'] = 'pinet_';
